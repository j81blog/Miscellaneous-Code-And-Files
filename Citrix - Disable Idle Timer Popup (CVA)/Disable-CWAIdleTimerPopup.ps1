<#
    .SYNOPSIS
        Disables the idle timer popup messages for Citrix Workspace App.

    .DESCRIPTION
        This script disables the idle timer popup messages for Citrix Workspace App by modifying the EnableTimeoutWarning property of the Win32_TSSessionSetting class.
        https://support.citrix.com/s/article/CTX555711

    .EXAMPLE
        Disable-CWAIdleTimerPopup.ps1
        Disables the idle timer popup messages for Citrix Workspace App.

    .NOTES
        File Name      : Disable-CWAIdleTimerPopup.ps1
...
try {
    Write-Host "Before:"
    Get-CimInstance -ClassName Win32_TSSessionSetting -Namespace root/CIMV2/TerminalServices | Where-Object {$_.TerminalName -like "ICA*"} | Select-Object TerminalName, EnableTimeoutWarning
    Write-Host "`r`nDisabling popup messages"
    Get-CimInstance -ClassName Win32_TSSessionSetting -Namespace root/CIMV2/TerminalServices | Where-Object {$_.TerminalName -like "ICA*"}  | ForEach-Object {$_ | Set-CimInstance -Property @{EnableTimeoutWarning=0} }
    Write-Host "`r`nAfter:"
    Get-CimInstance -ClassName Win32_TSSessionSetting -Namespace root/CIMV2/TerminalServices | Where-Object {$_.TerminalName -like "ICA*"} | Select-Object TerminalName, EnableTimeoutWarning
    Write-Host "Finished!"
    Exit 0
} catch {
    Wriyte-Host "Error detected: $($_.Exception.Message)"
    Throw $_
    Exit 1
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBaqsqnfGy5Zk72
# Ezb4QopOV05yvMj+1Pa5ds+I4LS9taCCICkwggXJMIIEsaADAgECAhAbtY8lKt8j
...
# o78tLeb49oyE/2434W/vgENTLwX/cHBLlJNsuKkT82kwDQYJKoZIhvcNAQEBBQAE
# ggGAxHLu8ObtivRZioJz7YPSJGLohfXmFrWAG527MkJOI6Ai2Tgqj+PyZatcvk9u
# 8uK283d7ifY7dTYnwNUYSa2tL/k1uMu0CVNXGY00Yk+RGPwZ9j9vNewPfP287Jy5
# 2w79COXEd6w2Lgllkc2ZPZNfrKbpzi2SFm81evWmpLtyyuV0vPtZUk4fGbBszyPH
# hQSTebvP2jI4qiviym+crqPjsRh17CxGQpfoixvKuUQK8S0tGapIggbNid43Er1q
# x625R7WnoXB6l2vUoIHJaRwInTk4joGNZUbLbRE7B4z62F2JYWdF3QCIG3RZNSuq
# s7TguTje0zUY6NrUlM5j41BwKzxuA8HcYP2mM4UKMjAd8EiHOIqHf+ej0eLgHenV
# oUhld4XyEdowI0iNnOI6FRBPlCcxs+ZO8rDL6eyZcalqcjxvJXHIwzj9z74ifv9k
# qdl7+xjiUNl+iuXsE5D4NKponnlzRVSPA9L5Fuh0mPfGRfaILhe64lFyja9r5GH+
# ao8HoYIEAjCCA/4GCSqGSIb3DQEJBjGCA+8wggPrAgEBMGowVjELMAkGA1UEBhMC
...
# KoZIhvcNAQkFMQ8XDTI0MDgxOTExMDE0M1owNwYLKoZIhvcNAQkQAi8xKDAmMCQw
# IgQg6pVLsdBAtDFASNhln49hXYh0LMzgZ5LgVgJNSwA60xwwPwYJKoZIhvcNAQkE
# MTIEMLIACwCPSNvEw9Y4JZEGwn8TKfLRtF+poQRM3lsjE/nVNanQwKLYZb9zqfcM
# Ec0cqjCBnwYLKoZIhvcNAQkQAgwxgY8wgYwwgYkwgYYEFA9PuFUe/9j23n9nJrQ8
...
# MSBDQQIQCcXM+LtmfXE3qsFZgAbLMTANBgkqhkiG9w0BAQEFAASCAgCQTLpxyAiP
# gNGejNXRu1LNS+lKFBS7DxYAYL2ERupsiEtW1atQdldo1/U7T3i4amwqNojCh47k
# wettDaXG1g3swd4xoP7OGjTmpn8325yCWpDZfI1UquRZFlYVzRx7lCdQiXpJe3xg
# MJlwYJrTa2WYNxgg1LLJa2CyIB1/DD/zAQ7syjln+29LK0qbEL1wrfE2IbIXl6GG
# Lm2Tcha8kIdpQE/1j40QCUYz8mWxE/S+Os9KXCWZ+ISv2S+6ioH3XKaL0Ct7l9Ax
# XoS7dRvfnEeogfGRSfDGUSjnpdFqNWPu+A4E3HHLj9Yq6er1azvTaynK3rrQ/QP2
# 7BKmBECKZ31XFRKpriLshd1aQXcKlvIU/XXgj4Wo+dI8H8FX48V/t5QT2g4i8OgD
# BKAwyWnPSBxhczqlCuwhU0acafWM+anwCX/WHKPMn3mHcbIV1GQwx69P9t8VjUN1
# yylJmR29NfRhMpgKLUFlO2LNaFK8/jcAa3GK4EC4DdikpbxBPTyEmcCKesPtTAJ5
# cSQYrH4hm8usNq+J0ZGGP2WtVQlF+cICpS2lETsupyNvZPZu5EbMUYLaUmu+T/aZ
# yqk6YrldIX6nYrjQdrIeki9W+EHNAgbJbp9swMJfaVvcF9oH2fXnmZNOw865YeiT
# yjwPpYnpGzeorzRHRy7ZfmMgPreaFfpv2w==
